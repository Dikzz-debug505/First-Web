...
(function (global) {
  ...
  const dict = {
    id: {
      ...
      'header.subtitle': 'Hero.bytes, Document Extractor, GameObject Overrider & Python Encrypted',
      'header.logout': 'Keluar',
      'header.online': 'Online',
      'tab.hero': '🧬 Hero.bytes Viewer',
      'tab.doc': '📦 DocumentExtractor',
      'tab.go': '⚡ GameObject Overrider',
      'tab.py': '🔐 Python Encrypted',
      'lang.label': 'Bahasa',
      'lang.id': 'Indonesia',
      'lang.en': 'English',
      ...
      'py.desc': 'Enkripsi file <strong>.py</strong> jadi skrip self-decrypt (AES-256 + multi-layer XOR/ROL). Semua proses di browser. Butuh <code>pycryptodome</code> saat dijalankan.',
      'py.pick': 'pilih file .py',
      'py.upload_hint': 'upload 1 file .py ke sini',
      'py.layers': 'Jumlah layer XOR/ROL (1–99)',
      'py.layers_hint': 'Lebih banyak layer = lebih lambat. Default 16 cukup kuat & cepat.',
      'py.encrypt': '🔐 encrypt & download',
      'py.stat.size': 'ukuran',
    ...
    en: {
      ...
      'py.desc': 'Encrypt a <strong>.py</strong> file into a self-decrypting script (AES-256 + multi-layer XOR/ROL). All processing is in-browser. Requires <code>pycryptodome</code> at runtime.',
      'py.pick': 'choose .py file',
      'py.upload_hint': 'drop one .py file here',
      'py.layers': 'XOR/ROL layers (1–99)',
      'py.layers_hint': 'More layers = slower. Default 16 is strong and fast enough.',
      'py.encrypt': '🔐 encrypt & download',
      'py.stat.size': 'size',
      'py.stat.layers': 'layers',
